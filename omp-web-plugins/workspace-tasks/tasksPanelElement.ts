...
export const tasksPanelTagName = "omp-web-workspace-tasks-panel";

const configChangedEvent = "omp-web-workspace-tasks-config-changed";
...
export function defineTasksPanelElement(): void {
  if (!customElements.get(tasksPanelTagName)) customElements.define(tasksPanelTagName, OmpWebTasksPanel);
}
...
class OmpWebTasksPanel extends HTMLElement {
