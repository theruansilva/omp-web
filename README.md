...
[![npm version](https://img.shields.io/npm/v/@theruansilva/omp-web)](https://www.npmjs.com/package/@theruansilva/omp-web)
[![Node.js](https://img.shields.io/node/v/@theruansilva/omp-web)](package.json)
...
```bash
bun install -g @theruansilva/omp-web
omp-web install
omp-web doctor
```
