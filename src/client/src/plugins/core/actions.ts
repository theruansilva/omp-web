...
export function createCoreActions(): PluginAction[] {
  return [
    ...
    },
    {
      id: "machine.add",
      title: "Add Machine",
      description: "Register another OMP runtime reachable from this gateway",
      group: "Machine",
    ...
    },
    {
      ...
      description: "Check whether the selected OMP runtime is online",
      group: "Machine",
      run: (context) => context.refreshSelectedMachine(),
    },
    {
      id: "machine.open",
      title: "Open Selected Machine OMP",
      description: "Open the selected remote OMP directly in a new tab",
      group: "Machine",
    ...
    },
    {
      id: "theme.select",
      title: "Select Theme",
      description: "Choose the OMP color theme",
      group: "Preferences",
    ...
    },
    {
      id: "settings.open",
      title: "Open Settings",
      description: "Manage OMP configuration and keyboard shortcuts",
      shortcut: "mod+,",
      group: "Preferences",
    ...
    },
    {
      ...
      description: "Reload the OMP browser page",
      group: "General",
